...
- 仅当负载时电阻性的，放电才会是指数型的。
- 电容进度通常是20%或更高，考虑到制造差异，**设计时可以尽量保守，即允许元件的最差情形组合**。
:::
...
1. 所需的电容可能笨重又昂贵；
2. 因为二极管有限内阻等导致等效电路`R>0`，仍然存在输出电压可能因输入电压、负载变化而变化的问题。

一种较好的方案是先用足够大的电容降低波纹 ( 也许是直流电压的10% ) ，然后用一个有源反馈电路来消除遗留的波纹。这种反馈电路“监测”输出端，用一个可控制的串联电阻 ( 晶体管 ) 进行必要的调整，保证输出电压恒定。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/25.png" width="300" style="margin: auto"/>
...
[检波器](https://baike.baidu.com/item/%E6%A3%80%E6%B3%A2%E5%99%A8/7567676?fr=ge_ala)是比较宽泛的概念，这里使用二极管来获得单极性波形。

但对于峰峰值低于正向压降 ( 通常 0.6V ) 的波形则无输出。解决方法有二：

1. 更换元件：**主载流子二极管** ( 肖特基二极管 ) ，正向压降仅 0.25V 。
2. 采用下图电路，用一个二极管提供偏压进行补偿。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/26.png" width="160" style="margin: auto"/>

在简易收音机当中也有应用。该电路中 LC负责选频，取出所需频率的调制波，二极管检波后由电容去除载波，就可以输出原始声音信号了。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/34.png" width="240" style="margin: auto"/>

#### 二极管门电路

一个较好的例子是电池备用电路。电源未出故障时，电池不起作用；电源有问题时，它取代电源不间断供电。( 电源电压需高于电池电压 )

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/27.png" width="270" style="margin: auto"/>

#### 二极管钳位器

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/28.png" width="220" style="margin: auto"/>
...
![分压器钳位](../../../../assets/images/29.png)

解决方法：

1. 在 1kΩ 电阻两端加上旁路电容 ( 仅高频有效 )。相当于 667Ω 与一个感抗并联，频率越大，感抗越小，并联阻值越小。
2. 较好的方法，采用晶体管或运算放大器，因为不用很小的电阻，从而补损耗很大的电流，却能提供几欧或更小的阻抗。
3. 采用运算放大器作为钳位电路的一部分。( 参见第4章 )
   
钳位电路还可以用于**直流恢复**，对于一些电路 ( 如发射极接地的晶体管电路 ) 尤为重要，否则经过耦合的信号将渐渐消失。 图中输出信号正的峰值不变，负的值被钳位在 -0.6V 。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/30.png" width="200" style="margin: auto"/>

#### 限幅器

图中的限幅器限制幅值在 0.6V 比较小，但可以设置两端的电源电压 ( 而不是接地 ) 。它常用于高增益的放大器的输入保护电路，防止输入太大而输出“饱和”。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/31.png" width="200" style="margin: auto"/>
...
<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/32.png" width="480" style="margin: auto"/>
...
这种保护电路唯一缺陷是增加了电感电流衰减时间。在要求电流必须快速衰减的场合 ( 高速击打式打印机、高速继电器 ) ，我们可以改用并联一个电阻作为保护电路。但要计算好，确保`V ( 瞬时 ) - I ( 初始 ) R`小于开关两端可允许的最大电压值。欲得到给定最大电压值内的最快衰减，可采用齐纳二极管来替代，它给出了斜坡向下的电流衰减，而非指数衰减。

对于由交流电驱动的电感电路，上述保护电路不起作用，二极管会交替在半周期内导通。这种情况我们采用并联 RC “阻尼”网络 [( 视频理解 ) ](https://www.bilibili.com/video/BV1zV411R7Da/?vd_source=1e7e12674eea82df675998b72b593965)。 LC 组成振荡网络，而 R 用于吸收能量，使之快速衰减。图中为小感性负载的典型值。一种可替换的保护器件是金属氧化物变阻器，即**过渡型阻尼器**。

<img src="https://raw.githubusercontent.com/maindraster/maindraster.github.io/main/src/assets/images/33.png" width="500" style="margin: auto"/>

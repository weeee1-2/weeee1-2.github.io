...
8. 在你的应用（左下角九个点打开）有三只企鹅，打开 Fcitx config （大概叫这个），取消勾选`Only Show Current Language`，右侧选择`Pinyin`点击`<`添加进去。右上角有个键盘可以切换输入法。终于搞定了！
</Steps>
...
:::tip[参考资料]
这篇我写的[Linux ( Ubuntu ) 系统装clash](https://zhuanlan.zhihu.com/p/692414049)不错！
:::
